...
public class Zoo {
    public static void main(String args[]) throws FileNotFoundException {
        ...
        // intalize zoo-keeper (SUBJECT)
        ZooKeeper steveIrwin = new ZooKeeper();
        // intalize zoo-announcer (OBSERVER)
        ZooAnnouncer barnum = new ZooAnnouncer(steveIrwin);
        ...
        // zoo keeper duties
        String[] zoo_keeper_duty = {"waking up", "roll calling", "exercising", "feeding", "putting to sleep"};

        for(String state : zoo_keeper_duty){
            steveIrwin.setState(state);
            steveIrwin.executeState(animals);
        }
        steveIrwin.deconstruct(barnum);
    }
}
